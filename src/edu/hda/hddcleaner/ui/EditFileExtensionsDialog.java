...
public class EditFileExtensionsDialog extends JDialog{
    private Color dialogBackgroundColor;
    private JPanel dialogPanel;
    private JLabel headLineLabel;
    private JTabbedPane dialogTabbedPane;

    public EditFileExtensionsDialog() {
    ...
    private void initHeadLineLabel() {
        this.headLineLabel = new JLabel("Dateiendungen bearbeiten", new ImageIcon("icons/trichter.jpg"), JLabel.LEFT);
    ...
    private void initDialogTabbedPane() {
        ...
        this.dialogTabbedPane.addTab("Übersicht", new NewProfilePanel());
        this.dialogTabbedPane.addTab("Endung hinzufügen", new NewFileExtensionsPanel());
        this.dialogTabbedPane.addTab("Endung entfernen", new DeleteFileExtensionsPanel());

        for (int i = 0; i < this.dialogTabbedPane.getTabCount(); i++) {
            this.dialogTabbedPane.setBackgroundAt(i, Color.WHITE);
        }
//        this.dialogTabbedPane.add(new NewProfilePanel(), 0);
    }
